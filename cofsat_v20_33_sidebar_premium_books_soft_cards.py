...
def main() -> None:
    ...
    st.markdown("<div class='mini-note' style='margin-bottom:.7rem;'>Bir editör adına bastığınızda yorumu ve hemen altında yalnızca o editöre ait puan alanı görünür.</div>", unsafe_allow_html=True)
    ...
    for tab, name in zip(quick_tabs, EDITOR_NAMES):
        with tab:
            ...
            render_single_editor_score_box(current_image_hash, name, editor_scores, key_prefix=f"quick_{name}")
    st.markdown("</div>", unsafe_allow_html=True)

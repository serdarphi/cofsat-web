        ...
        <div class="cofsat-hero-shell">
            <div class="cofsat-hero-grid">
                ...
                <div class="cofsat-hero-side">
                    <div class="cofsat-hero-badge">🏆 Günün Fotoğrafı</div>
                    <div class="cofsat-hero-side-inner">
                        <div class="cofsat-hero-side-title">Ana ekran vitrini</div>
                        <div class="cofsat-hero-side-note">
                            Günün en yüksek puanlı fotoğrafı ana sayfada öne çıkarılır; havuzda ise rozet ile görünür hale gelir.
                        </div>
                    </div>
                </div>
            </div>

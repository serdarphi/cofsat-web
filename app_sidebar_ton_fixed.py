...
def inject_css() -> None:
    st.markdown(
        ...
        section[data-testid="stSidebar"] {
            background: linear-gradient(180deg, #f3a255 0%, #e98b3f 100%) !important;
        ...
        section[data-testid="stSidebar"] .sidebar-card {
            ...
            box-shadow: 0 14px 32px rgba(114, 58, 13, 0.12) !important;
...
def main() -> None:
    ...
    components.html(
        ...
        const go = () => {
          ...
          const el = mainDoc.getElementById('analysis-results');
          if (el) {

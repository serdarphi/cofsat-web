...
def inject_css() -> None:
    st.markdown(
        ...
        .upload-panel {
            text-align:center;
            padding: .72rem .95rem .5rem .95rem;
            margin-top: .75rem;
            margin-bottom: .15rem;
            background:
                linear-gradient(135deg, rgba(255,255,255,0.07), rgba(255,255,255,0.035)),
                radial-gradient(circle at top, rgba(104,213,255,0.06), transparent 60%);
        }
        .upload-icon {
            width: 44px;
            height: 44px;
        ...
        section[data-testid="stFileUploaderDropzone"] {
            ...
            background:
                linear-gradient(180deg, rgba(255,255,255,0.995), rgba(248,250,252,0.995)) !important;
...
def main() -> None:
    ...
    st.markdown(
        ...
        <div class="upload-panel">
            ...
            <div class="upload-hint">Dosyanızı sürükleyip bırakın veya dosya seçin.</div>

...
def _render_single_photo_pool(context: str, now: datetime, pool_date: str) -> None:
    ...
    if context == "sidebar":
        ...
        if is_future_pool:
            st.info(
                ...
                f"Saat {PHOTO_POOL_CLEANUP_HOUR:02d}:00'de bugünün havuzu temizlenir; bu panel ertesi gün adaylarını da görünür tutar."
            )
        elif pod.get("ready"):
    ...
    if is_future_pool:
        status_text = (
            ...
            f"Saat {PHOTO_POOL_CLEANUP_HOUR:02d}:00 sonrasını beklemeden bu havuz burada görünür kalır."
        )
    else:
        status_text = (

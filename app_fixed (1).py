...
def render_sidebar(selected_mode: str, selected_editor_mode: str, selected_editor_name: str) -> None:
    with st.sidebar:
        ...
        st.markdown("<div class='mini-note'>Aşağıda tüm editörlerin aynı fotoğrafa özel yorumları ayrı ayrı görünür.</div>", unsafe_allow_html=True)
...
def main() -> None:
    ...
    with top_right:
        ...
        with c4:
            st.metric("Editör", selected_editor_name)

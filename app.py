    ...
    st.markdown(
        ...
        .upload-panel {
            ...
            background:
                ...
                radial-gradient(circle at top, rgba(104,213,255,0.08), transparent 65%);
        }
        .upload-icon {
            width: 64px;
            height: 64px;
...
def main() -> None:
    ...
    st.markdown(
        ...
        <div class="upload-panel">
            ...
            <div class="upload-hint">Beyaz alana tıklayın ya da fotoğrafı sürükleyip bırakın. Yükleme yazısı artık kutu içinde net görünür.</div>

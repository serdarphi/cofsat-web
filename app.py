...
def _render_single_photo_pool(context: str, now: datetime, pool_date: str) -> None:
    ...
    if context == "sidebar":
        ...
        st.markdown(
            f"<div class='mini-note'>Nihai puan: {get_entry_display_score(pod):.1f}/100 · Sıralama: {get_entry_rank_score(pod):.1f} · Havuz: {int(pod.get('entries', 0))} fotoğraf</div>",
            unsafe_allow_html=True,
        )
        if is_future_pool:
            st.info(
        ...
        for idx, entry in enumerate(entries[:6]):
            ...
            with cols[1]:
                ...
                st.caption(f"Sıralama: {get_entry_rank_score(entry):.1f} · Nihai: {get_entry_display_score(entry):.1f}")
        ...
        with col:
            ...
            st.markdown(
                ...
                <div class='candidate-score-row'>
                    ...
                    <span class='score-pill'>Nihai {final_score:.1f}</span>
                </div>
...
def main() -> None:
    ...
    if hero_pod:
        hero_side_note = (
            ...
            f"Nihai puan: {get_entry_display_score(hero_pod):.1f}/100 · "
            ...
            <div class="cofsat-hero-grid">
                <div class="cofsat-hero-copy">
                    <div>
                        ...
                        <div class="cofsat-hero-title">ÇOFSAT</div>

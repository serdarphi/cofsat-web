...
def inject_css() -> None:
    st.markdown(
        ...
        /* Upload alanını sadeleştir ve sol metni ortala */
        ...
        /* Sağdaki Dosyaları Gez butonu görünür ve okunur kalsın */
        ...
        [data-testid="stFileUploaderDropzone"] button[kind="secondary"] {
            ...
            color: #fff !important;
            border: 1px solid rgba(255,255,255,.18) !important;
            box-shadow: 0 8px 18px rgba(192,122,74,.18) !important;
...
def main() -> None:
    ...
    if uploaded_file is None:
        # Fotoğraf yüklenmeden önce havuz görünür.
    ...
    with st.spinner("Fotoğraf analiz ediliyor..."):
        ...
        save_photo_result(image_bytes, uploaded_file.name, result)
    ...
    # Fotoğraf yüklendiğinde analiz sonuçları önce görünür; havuz ise bunların altında kalır.
    render_turkey_time_info(context="main")
    render_photo_of_day_candidates(context="main")

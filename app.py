...
st.markdown("""
<style>
/* --- FIX: Streamlit sidebar collapse icon text leak (keyboard_double...) --- */
...
/* Keep sidebar first content tight and branded */
.cofsat-sidebar-top-brand {
    margin: .15rem 0 .75rem 0;
    padding: .95rem .95rem .85rem .95rem;
    border-radius: 22px;
    background: linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.035));
    border: 1px solid rgba(255,255,255,.10);
    box-shadow: 0 12px 28px rgba(0,0,0,.12);
}
.cofsat-sidebar-top-title {
...
def main() -> None:
    ...
    with st.sidebar:
        st.markdown(
            """
            <div class='cofsat-sidebar-top-brand'>
                <div class='cofsat-sidebar-top-title'>ÇOFSAT</div>
                <div class='cofsat-sidebar-top-subtitle'>Fotoğraf Ön Değerlendirme</div>
                <div class='cofsat-sidebar-api-ok'>OpenAI API aktif · gpt-4o-mini</div>
            </div>
            """,
            unsafe_allow_html=True,
        )

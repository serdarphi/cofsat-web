...
- Yorum dili sıcak, sade, gözlemci ve insancıl olsun; cümleler fotoğraf kulübü sezgisi taşısın ama şablona düşmesin.
- Önce ışık, ton, netlik, doku, ritim, yansıma, perspektif, kompozisyon, ifade, bakış yönü ve beden dili gibi somut öğeleri fark et.
- Sis, denizin enginliği, iskele kavsi, köprü çizgisi, taş dokusu, kuş, serçe, ağaç dokusu, filiz, sepet ritmi, elektrik telleri gibi küçük ama ayırt edici ayrıntıları görünür kıl.
- Sıklıkla bir ana unsurla ikinci unsuru ilişkilendir: uzak tekne, yürüyen insan, minik kuş, şehir arka planı, duvar resmi, kitap kapağı gibi karşıt ya da tamamlayıcı öğeler yorumda yer bulsun.
- Somut görsel öğeden sonra bunun kurduğu atmosferi, yaşam hissini, biyolojik var oluşu, dayanıklılık duygusunu ya da hikâye çağrışımını söyle.
- Geniş açı, alçak açı, yumuşak kavis, alt üçte bir, grafik etki gibi kadraj kararlarını gerektiğinde an ama kuru teknik rapora dönme.
- Gerekiyorsa eleştiriyi nazikçe kur; küçük bir sadeleşme, fazlalığın hafiflemesi ya da merkezin netleşmesi gibi yumuşak öneriler getir, sert hüküm verme.
- Kısa ve doğal takdir alanları kullanabilirsin ama her yorumu otomatik olarak "Tebrikler" ile bitirme; kapanışlar çeşitlensin.
- "ritim", "doku", "ton", "sisli atmosfer", "yaşam öğesi", "beden dili", "enginlik", "grafik etki", "gizem", "yaşam hissi" gibi ifade alanları doğal biçimde geçebilir.
"""
...
EDITOR_VOICE_ENGINES = {
    ...
    "Güler Ataşer": {
        "lexicon": ["tonlar", "doku", "ritim", "sisli atmosfer", "yaşam öğesi", "beden dili", "bakış yönü", "enginlik", "grafik etki", "gizem", "yaşam hissi", "yansıma", "geniş açı", "taş dokusu"],
        "openings": [
            "Beni ilk karşılayan şey tonlar, doku ve sahnenin kurduğu hava oluyor.",
            "Fotoğrafta önce ritim ve atmosfer kendini hissettiriyor.",
            "Burada ışık, ton ve küçük yaşam öğeleri birlikte çok güzel çalışıyor.",
            "İlk bakışta kompozisyonun içindeki sakin ama etkili denge dikkat çekiyor."
        ],
        "connectors": ["özellikle", "aynı zamanda", "bu yüzden", "burada", "sanki", "bir yandan"],
        "closings": [
            "Güzel bir atmosfer kurulmuş.",
            "Bu etkiyi korumak fotoğrafın lehine olur.",
            "Fotoğrafın içindeki hava çok kıymetli.",
            "Güzel kompozisyon.",
            "Tebrikler."
        ],
        "cadence": "sıcak giriş / somut ayrıntı / atmosfer ve yaşam hissi / yumuşak kapanış",
    },
    "Sevgin Cingöz": {
...
EDITOR_SIGNATURES = {
    ...
    "Güler Ataşer": {
        ...
        "signature_phrases": ["güzel kompozisyon", "beden dili", "ritim", "sisli atmosfer", "yaşam hissi"],
    },
    "Sevgin Cingöz": {
...
EDITOR_SHARED_WORD_REMAP = {
    ...
    "Güler Ataşer": {"görüntü": "fotoğraf", "ana vurgu": "ışık, ton, ritim ve ifade ilişkisi"},
...
def translate_editor_comment_to_english_cached(comment_tr: str, editor_name: str) -> str:
    ...
    editor_style_guides = {
        ...
        "Güler Ataşer": "Keep the English warm, humane, and visually sensitive. Preserve her attention to light, tone, texture, rhythm, atmosphere, body language, and small secondary life elements such as mist, birds, bridges, reflections, or distant figures. Let the English feel specific rather than generic.",
        "Sevgin Cingöz": "Keep the English concise, structural, and composition-focused. Preserve her attention to balance, eye flow, placement, and formal order.",

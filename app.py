...
def allow_local_fallback() -> bool:
    # OpenAI zorunluysa sessiz yerel/sabit yoruma düşme.
    # API key, kredi, limit veya model hatası varsa gerçek hata gösterilsin.
    if openai_is_forced():
        return False
...
def _openai_api_status_probe() -> Dict[str, str]:
    ...
    Başarılıysa hiçbir UI göstermez; sadece hata varsa ana ekranda gerçek sebebi yazar.
    """
...
def enforce_openai_api_healthcheck(stop_on_error: bool = True) -> None:
    """OpenAI zorunluysa gerçek API durumunu kontrol eder.
    Başarılı kontrolde sidebar/main UI'ya hiçbir şey basmaz; eski ÇOFSAT görünümünü bozmaz.
    """
...
# Girişten sonra, fotoğraf yüklenmeden önce API durumunu sessizce kontrol et.
